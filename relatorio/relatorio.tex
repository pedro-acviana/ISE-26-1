...
\author{Pedro Araujo Cordeiro Viana --- matrícula 202067452 \\
...
\subsection{Histórico: do CPUlator ao MSYS2}
...
o repositório mantém um script auxiliar, \code{tools/build\_cpulator.py}, que
...
./jogo.exe
\end{lstlisting}
    Para rodar fora desse terminal (por exemplo, dando duplo clique no
    Explorer), basta copiar \code{SDL2.dll} para a mesma pasta do
    executável.
\end{enumerate}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}p{4.2cm}p{7.5cm}c@{}}
        ...
        Teclado USB / Mouse / Acelerômetro / \mbox{PS2 Joystick} & --- & Não implementado \\
        \bottomrule
    \end{tabular}
...
\begin{figure}[H]
    ...
    \node[umlclass] (plataforma) at (5.2,4.3) {
    ...
    \node[umlclass] (vilao) at (10.4,4.3) {
    ...
    \node[umlclass] (projetil) at (15.6,4.3) {
    ...
    \node[umlclass] (recordes) at (7,-0.3) {
    ...
    % associações (agregação: losango vazio do lado do "todo")
    \draw[-{Diamond[open]}] (jogo.west) .. controls +(-2,-1) and +(0,2) .. node[pos=0.55,left,font=\tiny]{1} (player.north);
    \draw[-{Diamond[open]}] (jogo.south) -- node[pos=0.6,right,font=\tiny]{6} (plataforma.north);
    \draw[-{Diamond[open]}] (jogo.east) .. controls +(1,-1) and +(-1,2) .. node[pos=0.55,right,font=\tiny]{1} (vilao.north);
    \draw[-{Diamond[open]}] (jogo.east) .. controls +(2,-1) and +(0,2) .. node[pos=0.6,right,font=\tiny]{0..1} (projetil.north);
    \draw[-{Diamond[open]}] (jogo.south) .. controls +(0,-2) and +(0,2) .. node[pos=0.6,left,font=\tiny]{1} (recordes.north);

    \draw[-] (player.east) -- (plataforma.west) node[midway,above,font=\tiny]{colide com};
    \draw[->,dashed] (vilao.south) -- node[midway,right,font=\tiny]{cria} (projetil.south west);
    \draw[-] (projetil.west) -- node[midway,above,font=\tiny]{colide / reflete} (player.east);
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[>=Stealth, font=\small]
        % atores
        \foreach \x/\nome/\txt in {0/jogador/{:Jogador}, 4/kirby/{:Kirby}, 8/projetil/{:Projétil}, 12/vilao/{:Vilão}} {
            \node[draw, minimum width=2.2cm, align=center] (\nome) at (\x,0) {\txt};
            \draw[dashed] (\nome.south) -- ++(0,-8);
        }

        \draw[->] (jogador.south) ++(0,-0.8) -- node[above,font=\scriptsize]{segura parry} ($(kirby.south)+(0,-0.8)$);
        \draw[->] ($(projetil.south)+(0,-1.8)$) -- node[above,font=\scriptsize]{colide (indo)} ($(kirby.south)+(0,-1.8)$);
        \draw[->] ($(kirby.south)+(0,-2.8)$) -- node[above,font=\scriptsize]{reflete (refletido=1)} ($(projetil.south)+(0,-2.8)$);
        \node[font=\scriptsize] at ($(projetil.south)+(1.4,-4.3)$) {(move em linha reta)};
        \draw[->] ($(projetil.south)+(0,-5.6)$) -- node[above,font=\scriptsize]{colide (voltando)} ($(vilao.south)+(0,-5.6)$);
        \draw[->] ($(vilao.south)+(0,-6.8)$) to[out=200,in=160,looseness=6] node[left,font=\scriptsize]{vidas--} ($(vilao.south)+(0,-6.8)$);
    \end{tikzpicture}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.18\textwidth}
        \centering \includegraphics[height=2.2cm]{figuras/kirby_idle.png}
        \caption{Pulando}
    \end{subfigure}
    \begin{subfigure}{0.18\textwidth}
        \centering \includegraphics[height=2.2cm]{figuras/kirby_neutro.png}
        \caption{Parado}
    \end{subfigure}
    \begin{subfigure}{0.18\textwidth}
        \centering \includegraphics[height=2.2cm]{figuras/kirby_parry.png}
        \caption{Parry}
    \end{subfigure}
    \begin{subfigure}{0.18\textwidth}
        \centering \includegraphics[height=2.2cm]{figuras/kirby_atingido.png}
        \caption{Atingido}
    \end{subfigure}
    \begin{subfigure}{0.18\textwidth}
        \centering \includegraphics[height=2.2cm]{figuras/kirby_campeao.png}
        \caption{Campeão}
    \end{subfigure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.14\textwidth}
        \centering \includegraphics[height=1.8cm]{figuras/vilao_parado.png}
        \caption{Vilão}
    \end{subfigure}
    \begin{subfigure}{0.14\textwidth}
        \centering \includegraphics[height=1.8cm]{figuras/vilao_atingido.png}
        \caption{Atingido}
    \end{subfigure}
    \begin{subfigure}{0.14\textwidth}
        \centering \includegraphics[height=1.8cm]{figuras/vilao_explodido.png}
        \caption{Explodindo}
    \end{subfigure}
    \begin{subfigure}{0.14\textwidth}
        \centering \includegraphics[height=1.8cm]{figuras/projetil_vilao.png}
        \caption{Projétil}
    \end{subfigure}
    \\[6pt]
    \begin{subfigure}{0.20\textwidth}
        \centering \includegraphics[height=1.4cm]{figuras/plataforma_gelo.png}
        \caption{Gelo íntegro}
    \end{subfigure}
    \begin{subfigure}{0.20\textwidth}
        \centering \includegraphics[height=1.4cm]{figuras/plataforma_derr1.png}
        \caption{Derretendo 1}
    \end{subfigure}
    \begin{subfigure}{0.20\textwidth}
        \centering \includegraphics[height=1.4cm]{figuras/plataforma_derr2.png}
        \caption{Derretendo 2}
    \end{subfigure}
    \begin{subfigure}{0.20\textwidth}
        \centering \includegraphics[height=1.4cm]{figuras/plataforma_derr3.png}
